...
namespace FeatureFlag.Infrastructure.Auth
{
    ...
    public class GoogleAuthWithEmailsAttribute : Attribute, IAsyncAuthorizationFilter
    {
        private readonly string[] _allowedEmails;

        public GoogleAuthWithEmailsAttribute(params string[] allowedEmails)
        {
        ...
        public async Task OnAuthorizationAsync(AuthorizationFilterContext context)
        {
            ...
            try
            {
                ...
                if (!_allowedEmails.Contains(payload.Email, StringComparer.OrdinalIgnoreCase))
                {
